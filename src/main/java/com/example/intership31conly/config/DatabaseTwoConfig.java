...
public class DatabaseTwoConfig {
    ...
    public static final String JPA_REPOSITORY_PACKAGE = "com.example.intership31conly.Reposiroty.dbtwo";
    public static final String ENTITY_PACKAGE = "com.example.intership31conly.Model.dbtwo";
